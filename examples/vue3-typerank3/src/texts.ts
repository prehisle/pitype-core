...
你可以通过按回车键来输入它们。`,
  ...
  {
    id: 4,
    content: '编程是创建一组指令来告诉计算机如何执行任务的过程。',
    label: '简中 - 编程过程',
    language: 'zh-CN'
  },
...
你可以通過按回車鍵來輸入它們。`,
  ...
  {
    id: 10,
    content: '編程是創建一組指令來告訴計算機如何執行任務的過程。',
    label: '繁中 - 編程過程',
    language: 'zh-TW'
  },
